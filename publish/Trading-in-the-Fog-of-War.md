...
A public hub's location is visible to all players, including enemies. This makes it more vulnerable to attack, which affects how traders interact with it.
...
Under this new privacy model, EVE Frontier has fog-of-war mechanics where you don't know what's in a system until you scout it. Private trade hubs extends this into the economic layer. You don't just lack military intelligence about an opponent; you also don't know where their supply depots are, how well-stocked they are, or where their logistics converge.

This means that tribes managing private hubs are also managing information access. Who knows the location of which hubs, and how that information is compartmentalized, becomes an operational concern. The decision about who gets told what starts to resemble need-to-know access patterns.
